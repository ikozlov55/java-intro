...
public class MyHashMapQP<K, V> implements MyMap<K, V> {
    ...
    public MyHashMapQP(int initialCapacity) {
        this(initialCapacity, DEFAULT_MAX_LOAD_FACTOR);
    }

    public MyHashMapQP(int initialCapacity, float loadFactorThreshold) {
