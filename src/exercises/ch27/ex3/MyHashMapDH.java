...
public class MyHashMapDH<K, V> implements MyMap<K, V> {
    ...
    public MyHashMapDH(int initialCapacity) {
        this(initialCapacity, DEFAULT_MAX_LOAD_FACTOR);
    }

    public MyHashMapDH(int initialCapacity, float loadFactorThreshold) {
    ...
    public V get(K key) {
        ...
        int i = 1;
        int secondaryHash = secondaryHash(keySet().hashCode());
        while (table[index].getKey() != key) {
            index = (index + i * secondaryHash) % capacity;
        }
