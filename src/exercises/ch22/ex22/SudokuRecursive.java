...
public class SudokuRecursive {
    ...
    public SudokuRecursive() {
        grid = readAPuzzle();
    }

    public SudokuRecursive(int[][] grid) {
        this.grid = grid;
    }
    ...
    public static void printGrid(int[][] grid) {
        System.out.println(new SudokuRecursive(grid));
    }
    ...
    public boolean search() {
        ...
        return searchHelper(freeCellList, 0);
    }

    private boolean searchHelper(int[][] freeCellList, int k) {
        ...
        for (int l = 1; l <= 9; l++) {
            grid[i][j] = l;
            if (isValid(i, j, grid) && searchHelper(freeCellList, k + 1)) {
                return true;
            }
        }
        grid[i][j] = 0;
