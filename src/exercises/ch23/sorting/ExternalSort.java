...
public class ExternalSort {
    ...
    public static void run(String sourcefile, String targetFile) {
        String f1 = "src/exercises/ch23/f1.dat";
        String f2 = "src/exercises/ch23/f2.dat";
        String f3 = "src/exercises/ch23/f3.dat";
        try {
            int numberOfSegments = initializeSegments(MAX_ARRAY_SIZE, sourcefile, f1);
            merge(numberOfSegments, MAX_ARRAY_SIZE, f1, f2, f3, targetFile);
            new File(f2).delete();
            new File(f3).delete();
        } catch (IOException e) {
