...
class SinPlot extends Pane {
    ...
    private void paint() {
        ...
        PathTransition animation = new PathTransition(new Duration(4 * 1000), sinPolyline, circle);
